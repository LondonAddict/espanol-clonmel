...
const EXERCISES=[
  ...
  {topic:"Tener expressions",items:[
    {q:"No he dormido bien. Tengo ___.",opts:["sueño","hambre","frío","calor"],ans:0,hint:"not slept → tengo sueño"},
    {q:"¿Comemos? Tengo mucha ___.",opts:["sueño","hambre","frío","sed"],ans:1,hint:"hungry → tengo hambre"},
    {q:"¿Puedo cerrar la ventana? Tengo ___.",opts:["hambre","sueño","frío","calor"],ans:2,hint:"cold → tengo frío"},
    {q:"¡Tienes ___! Has ganado el premio.",opts:["miedo","sueño","suerte","hambre"],ans:2,hint:"won a prize → tienes suerte"},
    {q:"___ que trabajar mañana. (I have to)",opts:["Voy","Quiero","Tengo","Estoy"],ans:2,hint:"obligation = tener que"},
    {q:"¿Cuántos años ___? — Tengo 36.",opts:["eres","estás","tienes","haces"],ans:2,hint:"age → ¿cuántos años tienes?"},
    {q:"Tengo mucho ___. Voy a beber agua.",opts:["hambre","sueño","sed","frío"],ans:2,hint:"thirsty → tengo sed"},
    {q:"Tengo ___. Voy a poner la calefacción.",opts:["calor","sueño","hambre","frío"],ans:3,hint:"cold → tengo frío"},
  ]},
